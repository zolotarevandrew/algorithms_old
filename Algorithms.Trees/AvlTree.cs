...
namespace Algorithms.Trees
{
    public class AVLTree<T>
    {
        ...
        public AVLTree<T> Left => _left;
        public AVLTree<T> Right => _right;

        public AVLTree<T> AddNode(T item)
        {
        ...
        public void RemoveNode(AVLTree<T> node)
        {
            throw new NotImplementedException();
        }
    }
